...
\begin{enumerate}
    ...
    \item Evaluation Metrics: Quantitative measurements known as evaluation metrics are employed to evaluate the effectiveness of deep learning and other machine learning models. These metrics offer information about how effectively a model works for a particular job, such object identification, regression, or classification. \\
    \item Deep Learning: Deep learning is a branch of machine learning that extracts complicated patterns from data by training multi-layered artificial neural networks. Deep learning models in particular, deep neural networks have shown impressive results in a range of fields, such as speech recognition, computer vision, and natural language processing. We have used its one of the concept mentioned above that is CNN.
